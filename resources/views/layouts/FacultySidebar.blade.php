...
<body>
    <div class="container ">
        <div class="row">
            <div class="col-md-3">
                <div class="sidebar d-flex flex-column">
                    <div class="sidebar-top">
                        ...
                        <a href="{{ route('faculty.profile', ['faculty_ID' => $faculty->Faculty_ID]) }}"
                            class="@if (request()->routeIs('faculty.profile')) active @endif">
                            <i class="fas fa-user me-2"></i> Profile
                        </a>

                        <a href="{{ route('FAC.pendingannouncements', ['ID' => $faculty->Faculty_ID]) }}" class="@if (request()->routeIs('faculty.notifications')) active @endif">
                            <i class="fas fa-bell me-2"></i> Notifications
                        </a>

                        <a href="{{ route('FAC.liveannouncements',['ID'=>$faculty->Faculty_ID]) }}" class="@if (request()->routeIs('liveannouncements')) active @endif">
                            <i class="fas fa-bullhorn me-2"></i> Announcements
                        </a>

                        <a href="{{ route('faculty.result', ['faculty_ID'=>$faculty->Faculty_ID]) }}" class="@if (request()->routeIs('faculty.result')) active @endif">
                            <i class="fas fa-chart-bar me-2"></i> Evaluation & Grading
                        </a>
                    </div>
            ...
            <div class="col-md-9">
                <h1 class="text-center text-title2 mb-4"><strong>Faculty Portal</strong></h1>
                @if (session('success'))
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="editForm"
                    action="{{ route('faculty.profile.edit', ['faculty_ID' => $faculty->Faculty_ID]) }}"
...
<script>
    document.getElementById("resetID").onclick = () => alert("Kindly visit the Admin Office to reset your Credentials")
</script>
</body>
