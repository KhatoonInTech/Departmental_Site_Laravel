...
@section('content')
    <div class="container" style="margin-top:50px">
        ...
        <p class=" text-center text-title2  "><strong>DEPARTMENT OF COMPUTER ENGINEERING
            
            <br>Bahauddin Zakariya University, Multan </strong></p>
        ...
        <div class="row" style="margin-top:50px">
            ...
            <div class="col-md-8">
                ...
                <div class="mb-3 position-relative">
                    <p class="mb-2"><strong>GPA:</strong> {{ $student->GPA_2 }}</p>
                </div>
                ...
                <div class="mb-3 position-relative">
                    <p class="mb-2"><strong>Failed Courses:</strong> {{ $student->Fail_2 }}</p>
                </div>
                ...
                <div class="mb-3 position-relative">
                    <p class="mb-2"><strong>Your Semester Result:</strong>
                            ...
                            <a href="{{ asset('storage/student/document/Result_2.pdf') }}" target="_blank">Download Your Result</a>
