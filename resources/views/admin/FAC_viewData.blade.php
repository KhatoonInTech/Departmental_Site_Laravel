...
@section('content')
    <div class="container mt-4 data-card p-1">
        <h2 class="text-center text-title2 mb-4">
            ...
            &nbsp Faculty Data Management &nbsp
            <button type="button" class="btn btn-custom text-warning" data-bs-toggle="modal" data-bs-target="#facultyModal">
                Add Faculties
            </button>
        </h2>
                                ...
                                <td>
                                    ...
                                    <div style="margin-top:7%">
                                        <button class="btn btn-primary text-warning" style="padding:2px, color:#FFFFF"
                                            ...
                                            data-id="{{ $member->Faculty_ID }}" data-name="{{ $member->Name }}"
                                            data-context="faculty">
                                            Delete
                                        </button>
                                    </div>
                                </td>
              ...
              case 'position':
                ...
                case 'role':
                    ...
                    <select class="form-control" name="value" required>
                        ...
                        <option value="faculty" ${current === 'faculty' ? 'selected' : ''}>Faculty Member</option>
                    </select>`;
                    break;
...
<div class="modal fade" id="facultyModal" tabindex="-1" aria-labelledby="facultyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="facultyForm" action="{{ route('faculty.addData') }}" method="POST">
                    @csrf
                    @method('POST')
